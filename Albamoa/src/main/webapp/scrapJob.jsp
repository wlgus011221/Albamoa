...
<%
    ...
    String postQuery = "SELECT jp.job_id, jp.date, jp.title, jp.end_date " +
            "FROM job_posting jp " +
            "JOIN scrap_job sj ON jp.job_id = sj.job_id " +
            "WHERE sj.user_id = ?";
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <button class="button" onclick="location.href='scrapJobDelete.jsp?id=<%= post.get("id") %>'">삭제</button>
                    </td>
                </tr>
            <%
                }
