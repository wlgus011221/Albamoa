...
<body onload="initializeForm()">
    ...
    <div class="container">
		...
		<br>
		<form action="resumeUpdateProcess.jsp?resume_id=<%= resumeId %>" method="post">
			<input type="hidden" id="experience_type" name="experience_type" value="0">
            <label for="title">이력서 제목</label><br><br>
            <textarea id="title" name="title" rows="1"><%= title %></textarea><br><br>
            ...
            <div id="employment-details" class="employment-details">
                ...
                <div>
			        ...
			        <input type="date" id="start_date" name="start_date" value=<%= start_date %> onchange="calculateExperience()">
			        <label for="work-end">퇴사일</label>
			        <input type="date" id="end_date" name="end_date" value=<%= end_date %> onchange="calculateExperience()">
			    </div>
                <br>
                <label for="job-description">담당업무</label><br>
                <textarea id="job-description" name="business" rows="4"><%= business %></textarea><br><br>
            </div><br><br>
		    <label for="self-introduction">자기소개</label>
		    <textarea id="self-introduction" name="info" rows="5"><%= info %></textarea>
		    <br>
